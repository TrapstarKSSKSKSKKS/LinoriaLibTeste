...
pcall(function()
	...
	ToggleIcon = IconModule.new():setImage(16001024354):setTip("Open Linoria UI"):bindEvent("selected", function() task.spawn(Library.Toggle) end):bindEvent("deselected", function() task.spawn(Library.Toggle) end)
end)
